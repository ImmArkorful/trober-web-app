...
const Banner: NextPage = () => {
  return (
    <>
      <div className="flex flex-col items-center w-full text-center lg:mb-48 py-14 lg:h-screen lg:px-20 lg:flex-row bg-gradient-to-r from-gradientstart to-gradientend">
